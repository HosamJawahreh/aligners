...
<footer class="w3l-footer-66">
    ...
    <div class="cpy-right py-3">
        <p class="text-center text-light">Copyright © {{ date('Y') }} {{ $ApplicationSetting->item_name }}. All rights reserved | Developed by
            <a class="text-danger" href="https://brand-makers.net" target="_blank">Brand Makers</a>
        </p>
    </div>
    <!-- move top -->
