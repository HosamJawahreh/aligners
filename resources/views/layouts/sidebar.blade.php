...
<aside class="main-sidebar sidebar-light-info elevation-4">
    <a href="{{ route('dashboard')  }}" class="brand-link sidebar-light-info text-center">
        <img src="{{ asset('assets/images/logo.png') }}" alt="{{ $ApplicationSetting->item_name }}"   style="height:180px;">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="">
                <img src="{{ asset($photo) }}" class="img-circle1" alt="User Image" style="width:75px; border-radius:15px;">
            </div>
